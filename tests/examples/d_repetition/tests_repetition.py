...
from src.examples.d_repetition.repetition import get_sum, get_sum_for, test_config, sum_of_squares, for_sum_of_squares
...
class Test_Config(unittest.TestCase):
    ...
    def test_for_sum_of_squares(self):
        self.assertEqual(for_sum_of_squares(-1),0)
